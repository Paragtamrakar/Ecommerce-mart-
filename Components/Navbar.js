    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      ...
      <div className="px-4 pt-3 pb-4">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* CART BUTTON */}
          <button className="relative w-11 h-11 rounded-full border border-gray-200 bg-gray-50 flex items-center justify-center active:scale-95 transition">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full h-12 rounded-full border border-gray-200 bg-gray-50 px-5 text-sm outline-none focus:border-green-600 focus:bg-white transition"
          />
